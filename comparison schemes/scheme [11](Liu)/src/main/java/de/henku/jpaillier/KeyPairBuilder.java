...
public class KeyPairBuilder {
    ...
    /**
     * Sets an upper bound that is used for decrypting ciphertexts representing a
     * negative value.
     * <p>
     * In most cases the upper bound should be the same as of the underlying number
     * system -
